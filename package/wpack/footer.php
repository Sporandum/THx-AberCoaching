	...
	<div class="site-footer__middle">
		<div class="site-footer__wrapper">
			...
			<div class="site-footer__social-icons">
				<a href="https://www.linkedin.com/in/annaszeremeta/" target="_blank" rel="noreferrer"><i class="fab fa-linkedin"></i><span class="sr-only">linkedin : Anna Szeremeta</span></a>
				<a href="https://www.facebook.com/abercoaching" target="_blank" rel="noreferrer"><i class="fab fa-facebook-square"></i><span class="sr-only">facebook : abercoaching</span></a>
			</div>
		</div>
	</div>
	<div class="site-footer__bottom">
		<div class="site-footer__wrapper">
			<ul class="site-footer__links">
				...
				<li><a href="mailto:contact@abercoaching.com" target="_blank" rel="noreferrer">contact@abercoaching.com</a></li>
				<?php
