...
module.exports = {
	// Project Identity
	appName: 'wpack', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'wpack', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'THx-AberCoaching',
		author: 'Sporandum',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
